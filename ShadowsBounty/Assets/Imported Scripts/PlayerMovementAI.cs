...
public class PlayerMovementAI : MonoBehaviour
{
    ...
    //Input
    float x, y;
    //added new booleans in Sam's Code {
    ...
    private void MyInput()
    {
        ...
        //added sprint check and keycodes in Sam's Code {
    ...
    private void StartCrouch()
    {
        ...
        if (_movementState == PlayerState.RUN && grounded)
        {
    ...
    private void Movement()
    {
        ...
        //Sam's State checks {
        //if not moving originally and you go
        ...
        // if moving after standing still
        if (rb.velocity.magnitude < 0.5f)
        {
            //kinetic checks
            if (_movementState == PlayerState.RUN)
        ...
        //this code is altered by sam's code {
        ...
        //Chenged state check and added boolean check in sam's code {
