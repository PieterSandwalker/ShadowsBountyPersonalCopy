// GENERATED AUTOMATICALLY FROM 'Assets/Input/PlayerButtonInput.inputactions'
...
public class @PlayerButtonInput : IInputActionCollection, IDisposable
{
    ...
    ""maps"": [
        {
            ""name"": ""PlayerControls"",
            ""id"": ""2c49be68-0e5a-4a06-887a-c8bdc9a7f933"",
            ""actions"": [
                {
                    ""name"": ""Jump"",
                    ""type"": ""Button"",
                    ""id"": ""5394aebc-1de4-402d-a6c4-da9157d73881"",
                    ""expectedControlType"": """",
                    ""processors"": """",
                    ""interactions"": """"
                },
                {
                    ""name"": ""Sprint"",
                    ""type"": ""Button"",
                    ""id"": ""abdd0a3b-4626-470b-9e38-7a89f9060103"",
                    ""expectedControlType"": """",
                    ""processors"": """",
                    ""interactions"": """"
                },
                {
                    ""name"": ""Crouch"",
                    ""type"": ""Button"",
                    ""id"": ""90daed23-be40-467d-ae6b-1d026adf02fa"",
                    ""expectedControlType"": """",
                    ""processors"": """",
                    ""interactions"": """"
                }
            ...
            ""bindings"": [
                {
                    ""name"": """",
                    ""id"": ""09dad992-79ef-439d-a410-523b27b19bdf"",
                    ""path"": ""<Keyboard>/space"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
                ...
                {
                    ""name"": """",
                    ""id"": ""74e86626-fbe1-4a89-b80b-0f93a3b3a9e4"",
                ...
                {
                    ""name"": """",
                    ""id"": ""44c56602-f551-4c40-a058-065cb5642231"",
                ...
                {
                    ""name"": """",
                    ""id"": ""384602ea-f19a-4c2c-a76f-7fd417d4d4a1"",
                ...
                {
                    ""name"": """",
                    ""id"": ""4b2b70d8-9ce1-4552-b05f-0b1b0de3afc4"",
                    ""path"": ""<Keyboard>/c"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
                ...
                {
                    ""name"": """",
                    ""id"": ""03e61d70-d9f6-4d28-9096-d1b0e5f80975"",
    ...
    {
        private @PlayerButtonInput m_Wrapper;
        public PlayerControlsActions(@PlayerButtonInput wrapper) { m_Wrapper = wrapper; }
